...
function Fotter(){
    ...
    <div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
                    ...
                    <a className="flex items-center p-1 w-full">
                    <i className="bi bi-youtube w-50"></i>
                    </a>
    ...
    <div className="space-y-4">
        <h3 className="tracking-wide uppercase dark:text-gray-900 font-bold">Use Cases</h3>
        <ul className="space-y-3">
            <li>
                <a rel="noopener noreferrer" href="#">UI Design</a>
            </li>
            <li>
                <a rel="noopener noreferrer" href="#">UX Design</a>
            </li>
            <li>
                <a rel="noopener noreferrer" href="#">Wireframing</a>
            </li>
            <li>
    ...
    <div className="space-y-4">
        <h3 className="tracking-wide uppercase dark:text-gray-900 font-bold">Exlpore</h3>
        <ul className="space-y-3">
            <li>
            ...
            <li>
                <a rel="noopener noreferrer" href="#">Collabration features</a>
            </li>
            <li>
                <a rel="noopener noreferrer" href="#">Design process</a>
            </li>
            <li className="">
                <a rel="noopener noreferrer" className="" href="#">FigJam</a>
            </li>
            
        </ul>
    </div>
    <div className="space-y-4">
        <h3 className="uppercase dark:text-gray-900 font-bold">Resources</h3>
        <ul className="space-y-3">
            <li>
                <a rel="noopener noreferrer" href="#">Blog</a>
            </li>
            <li>
                <a rel="noopener noreferrer" href="#">Best Pratices</a>
            </li>
            <li>
